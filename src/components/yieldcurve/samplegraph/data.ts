...
import * as dummydata from './testYc.json'
...
export function getData(): any[] {
  ...
  export const dummyYieldCurve_old = 
  {    
    handle: {
    ...
    plot: {
      x: [new Date(2023,5,5),new Date(2023,5,25), new Date(2023,6,13)], y:[0.333044,0.443333838,0.4499021]
    }
  }
  ...
  export const dummyYieldCurve:YieldCurve =  dummydata as YieldCurve